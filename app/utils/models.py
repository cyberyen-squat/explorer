...
class MWEBBlocks(db.Model):
    __tablename__ = 'mweb_blocks'
    hash = db.Column(db.String,
                     primary_key=True,
                     unique=True)
    height = db.Column(db.Integer,
                       unique=True,
                       nullable=False)
    kernel_offset = db.Column(db.String,
                              unique=False,
                              nullable=False)
    stealth_offset = db.Column(db.String,
                               unique=False,
                               nullable=False)
    num_kernels = db.Column(db.Integer,
                            unique=False,
                            nullable=False)
    num_txos = db.Column(db.Integer,
                         unique=False,
                         nullable=False)
    kernel_root = db.Column(db.String,
                            unique=False,
                            nullable=False)
    output_root = db.Column(db.String,
                            unique=False,
                            nullable=False)
    leaf_root = db.Column(db.String,
                          unique=False,
                          nullable=False)
